...
## Habits I'll Build
1. Start every request with C.A.R.E. or R.C.T.O.
2. Use only fictional/anonymized data unless an approved tool allows otherwise.
3. Keep the raw source next to the AI output while verifying.
4. Mark gaps [Not Specified] instead of guessing.
5. Get human sign-off before sending anything important.
